...
class Writer {
    ...
    constructor(options = {}) {
        ...
        this.options = {
            maxBufferSize: (0, util_1.isNullOrUndefined)(options.maxBufferSize) ? MaxBufferSize : options.maxBufferSize,
            ...
            filter: options && options.filter || ((dbid) => true)
        };
    ...
    createMaterial(mat, imf) {
        ...
        if (!(0, util_1.isUndefined)(mat.opacity) && mat.opacity < 1.0 && material.pbrMetallicRoughness.baseColorFactor) {
